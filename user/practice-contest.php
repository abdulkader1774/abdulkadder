...
// Get all practice contests
$contests = $pdo->query("
    SELECT c.id, c.title, c.description, 
           (SELECT COUNT(*) FROM questions WHERE contest_id = c.id) AS question_count
    FROM contests c
    WHERE c.contest_type = 'practice' AND c.is_active = TRUE
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="practice-contest.php">
                                Practice
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Practice Contests</h1>
                </div>
                
                <?php if (empty($contests)): ?>
                    <div class="alert alert-info">No practice contests available at the moment.</div>
                <?php else: ?>
                    <div class="row">
                                ...
                                <div class="card contest-card h-100">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush mb-3">
                                            ...
                                            <li class="list-group-item">
                                                <strong>Type:</strong> Practice (No time limit)
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-footer bg-transparent">
                                        <a href="start-practice.php?contest_id=<?php echo $contest['id']; ?>" class="btn btn-primary w-100">Start Practice</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
