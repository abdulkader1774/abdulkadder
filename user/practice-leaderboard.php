...
$contests = $pdo->query("SELECT id, title FROM contests WHERE contest_type = 'practice' ORDER BY created_at DESC")->fetchAll();
...
<head>
    ...
    <title>Practice Leaderboards</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="practice-leaderboard.php">
                                Practice Results
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Practice Leaderboards</h1>
                    <?php if ($userPosition): ?>
